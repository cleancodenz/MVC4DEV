...
namespace Tests.DB2
{
    ...
    {
        public const string ConnectionString = "name=NorthwindEntities2";
        public const string ContainerName = "NorthwindEntities2";
        ...
        public NorthwindEntities2(string connectionString)
            : base(connectionString, ContainerName)
        {
            this.ContextOptions.LazyLoadingEnabled = true;
        }
    
        public NorthwindEntities2(EntityConnection connection)
